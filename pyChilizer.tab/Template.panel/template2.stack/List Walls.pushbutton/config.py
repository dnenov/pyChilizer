...
def include_description():
    form = forms.alert("Do you want to include the description (thickness, layer, material) of the wall composition?", title='include description', warn_icon=False, yes=True, no=True, ok=False)
    if form:
